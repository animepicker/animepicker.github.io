                        ...
                        <div className="flex-1 overflow-y-auto custom-scrollbar p-5 space-y-6">
                            <div className="space-y-2">
                                ...
                                <button
                                    ...
                                    className="flex items-center justify-between w-full p-3 rounded-xl bg-white/5 border border-white/10 text-gray-300 hover:text-red-400 hover:bg-red-500/5 hover:border-red-500/20 transition-all group"
                                >
                                    <div className="flex items-center gap-3">
                                        <Trash2 size={18} />
                            ...
                            <div className="pt-4 border-t border-white/10 space-y-2">
                                <button
                                    ...
                                    className="flex items-center justify-between w-full p-3 rounded-xl bg-white/5 border border-white/10 text-gray-300 hover:text-white hover:bg-white/10 hover:border-white/20 transition-all group"
                                >
                                    <div className="flex items-center gap-3">
                                        <Terminal size={18} />
                                        <span className="text-sm font-medium">Console Logs</span>
                                    </div>
                                    <ChevronDown size={16} className="-rotate-90 text-gray-600 group-hover:text-white transition-all" />
                                </button>
                            </div>
...

                {
                    currentView === 'console' && (
                        <motion.div
                            ...
                            className="flex flex-col h-full"
                        >
                            <MenuHeader title="Console Logs" />
                            <div className="flex-1 overflow-hidden flex flex-col">
                                <div className="p-4 border-b border-white/10 flex justify-end">
                                    <button
                                        onClick={onClearConsoleLogs}
                                        className="text-xs text-gray-400 hover:text-white flex items-center gap-1.5 px-3 py-1.5 rounded-lg hover:bg-white/5 transition-all"
                                    >
                                        <Trash2 size={14} />
                                        Clear Logs
                                    </button>
                                ...
                                <div className="flex-1 overflow-y-auto custom-scrollbar p-4 space-y-2 font-mono text-xs">
                                    {consoleLogs.length === 0 ? (
                                        ...
                                        consoleLogs.map((log, index) => (
                                            <div
                                                key={index}
                                                className={`p-2 rounded border break-all ${log.type === 'error' ? 'bg-red-500/10 border-red-500/20 text-red-200' :
                                                    log.type === 'warn' ? 'bg-amber-500/10 border-amber-500/20 text-amber-200' :
